...
const defaultTemplate = `{{#if description}}{{{description}}}{{/if}}
...
---- | :----: | :-------: | :--------: | -----------
{{#each props}}
**{{@key}}** | \`{{> (typePartial this) this}}\` | {{#if this.defaultValue}}\`{{{this.defaultValue}}}\`{{/if}} | {{#if this.required}}true{{else}}false{{/if}} | {{#if this.description}}{{{this.description}}}{{/if}}
{{/each}}
